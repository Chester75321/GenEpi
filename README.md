...
## Standalone App
(Latest News!) The standalone and installation free app - AppGenEpi (v.beta) is now released. Just download it than 1) chmod +x ./AppGenEpi_MacOS_beta and 2) sudo ./AppGenEpi_MacOS_beta for executing. Have fun~
